$(document).ready(function(){
	...
	// 	if ($(window).scrollTop() > $('.header').height() && !$('.header').is('.header_fixed')) {
	...
	// 	} else if ($(window).scrollTop() <= $('.header').height() && $('.header').is('.header_fixed')){
	// 		$(".header").css('opacity', '0').removeClass('header_fixed').css('opacity', '1');
	// 	}
	// });
});